...
using static EmailVerifyOTP.Infrastructure.OTPGenerateDBContext;
using EmailVerifyOTP.Infrastructure.EntityConfig;
...
namespace EmailVerifyOTP.Infrastructure
{
